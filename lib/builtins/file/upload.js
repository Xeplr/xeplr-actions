...
module.exports = {
  ...
  inputSchema: [
    ...
    { name: 'sourceConfig',  type: 'object',  default: {}, order: 3, group: 'Source & format',
    ...
    { name: 'formatConfig',  type: 'object',  default: {}, order: 5, group: 'Source & format',
    ...
    { name: 'primaryKeys',   type: 'array',   order: 13, group: 'Advanced' },

    // CONTROL
    { name: 'movementId',    type: 'string',  order: 20, group: 'Advanced' },
    { name: 'batchSize',     type: 'number',  default: 5000, order: 21, group: 'Performance' },
    { name: 'concurrency',   type: 'number',  default: 4,    order: 22, group: 'Performance' }
  ],
