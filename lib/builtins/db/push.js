...
module.exports = {
  ...
  inputSchema: [
    { name: 'dbType',      type: 'string',  required: true, default: 'postgres', order: 1,
      description: 'postgres | mysql | mssql | mongo' },
    ...
    { name: 'movementId',  type: 'string',  order: 7,
      description: 'Correlation key for rollback. Defaults to system.occurrenceId or a fresh id.' },
    { name: 'batchSize',   type: 'number',  default: 5000, order: 8 },
    { name: 'concurrency', type: 'number',  default: 4,    order: 9 }
  ],
